              ...
              <div class="col-lg-6">
                <div class="p-5">
                  ...
                  <form class="user" method="POST">
                    ...
                    <hr>
                    <p class="text-center">¿Necesitas ayuda? <a href="https://api.whatsapp.com/send?phone=+573158246716&text=Hola,%20necesito%20ayuda%20con%20mi%20cuenta" target="_blank">Contacta con Soporte</a></p>
                  </form>
                  <hr>
                </div>
              </div>
