...
$('#txt_cod_producto').keyup(function(e) {
  ...
  if (productos == "") {
    ...
    $('#txt_mprecio').attr('disabled', 'disabled');
  ...
  $.ajax({
    ...
    success: function(response){
      if(response == 0) {
        ...
        $('#txt_mprecio').removeAttr('disabled');
...
$('#add_product_venta').click(function(e) {
  ...
  if ($('#txt_cant_producto').val() > 0) {
    ...
    var mprecio = $('#txt_mprecio').val();
    var action = 'addProductoDetalle';
    $.ajax({
      url: 'modal.php',
      type: 'POST',
      async: true,
      data: {action:action,producto:codproducto,cantidad:cantidad,observacion:observacion,mprecio:mprecio},
      success: function(response) {
